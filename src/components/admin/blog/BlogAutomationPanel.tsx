...
function QualityScoreBadge({ score, passed }: { score: number; passed: boolean }) {
  ...
  return (
    <TooltipProvider>
      <Tooltip>
        ...
        <TooltipContent>
          <p>{passed ? "Validación superada" : `Score ${score}/100 - Requiere revisión`}</p>
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
  );
      ...
      <TabsContent value="automation" className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Genera artículos automáticamente cada {settings?.run_interval_days || 2} días con reescritura iterativa y validación de calidad
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg text-sm">
              ...
              <div>
                <p className="font-medium">Sistema de calidad activo</p>
                <p className="text-muted-foreground">
                  Cada artículo pasa por 2 pasadas de IA y validación editorial automática. 
                  Solo los artículos con score ≥70 se publican automáticamente.
                </p>
              </div>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Genera artículos inmediatamente o añade temas a la cola. Los temas del calendario editorial tienen prioridad.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
          ...
          <CardContent>
            {queueLoading ? (
              ...
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-sm">Los artículos se generarán con temas del calendario editorial o aleatorios</p>
              </div>
            )}
          </CardContent>
        </Card>

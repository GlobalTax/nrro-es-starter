...
export const TranslateBlogToCatalan = () => {
  ...
  const handleTranslate = async () => {
    ...
    try {
      toast.info("Iniciando traducción automática al catalán...");

      const { data, error } = await supabase.functions.invoke('translate-blog-to-catalan', {
        body: {}
      });
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Traducción Automática al Catalán
        </CardTitle>
        <CardDescription>
          Traduce automáticamente todos los posts del blog al catalán usando Google Translate API.
          Solo se traducirán los posts que aún no tengan traducción al catalán.
        </CardDescription>
      </CardHeader>

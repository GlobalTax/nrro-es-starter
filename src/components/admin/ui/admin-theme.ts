/**
 * INTRANET DESIGN SYSTEM - Apollo.io-inspired Theme
 * Navy sidebar, indigo accents, clean white content area
 */

// ============================================
// COLORES — Apollo palette
// ============================================
...
export const statusStyles: Record<StatusType, {
  ...
  pending: {
    bg: '#FEF3C7', text: '#D97706', border: '#FCD34D', label: 'Pendiente',
    bgClass: 'bg-amber-50', textClass: 'text-amber-700', borderClass: 'border-amber-200',
  },
  inactive: {
    bg: '#F3F4F6', text: '#6B7280', border: '#D1D5DB', label: 'Inactivo',
    bgClass: 'bg-gray-100', textClass: 'text-gray-600', borderClass: 'border-gray-200',
  },
  urgent: {
    bg: '#FEF2F2', text: '#DC2626', border: '#FECACA', label: 'Urgente',
    bgClass: 'bg-red-50', textClass: 'text-red-700', borderClass: 'border-red-200',
  },
  completed: {
    bg: '#ECFDF5', text: '#059669', border: '#A7F3D0', label: 'Completado',
    bgClass: 'bg-emerald-50', textClass: 'text-emerald-700', borderClass: 'border-emerald-200',
  },
  info: {
    bg: '#EEF2FF', text: '#4F46E5', border: '#C7D2FE', label: 'Info',
    bgClass: 'bg-indigo-50', textClass: 'text-indigo-700', borderClass: 'border-indigo-200',
  },
  default: {
    bg: '#F3F4F6', text: '#374151', border: '#D1D5DB', label: 'Default',
    bgClass: 'bg-gray-100', textClass: 'text-gray-700', borderClass: 'border-gray-200',
  },
};
...
export const priorityStyles: Record<PriorityType, {
  ...
  high: {
    bg: '#FEF2F2', text: '#DC2626', border: '#FECACA', label: 'Alta',
    bgClass: 'bg-red-50', textClass: 'text-red-700', borderClass: 'border-red-200',
  },
  medium: {
    bg: '#FEF3C7', text: '#D97706', border: '#FCD34D', label: 'Media',
    bgClass: 'bg-amber-50', textClass: 'text-amber-700', borderClass: 'border-amber-200',
  },
  low: {
    bg: '#F3F4F6', text: '#6B7280', border: '#D1D5DB', label: 'Baja',
    bgClass: 'bg-gray-100', textClass: 'text-gray-600', borderClass: 'border-gray-200',
  },
};
